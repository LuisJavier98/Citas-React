...
const ListadoPacientes = ({ editActive, data, seteditActive, setpaciente, deletePaciente }) => {
	...
	return (
		<div className='md:w-1/2 lg:w-3/5 md:h-screen overflow-auto'>
			<h2 className='font-black text-xl sm:text-3xl text-center'>Listado Pacientes</h2>
			...
			</p>
			{
				data.length !== 0 ?
					...
					:
					<p className='p-3 bg-red-700 text-center font-bold  text-sm  sm:text-lg'>No existen pacientes registrados</p>
			}
		</div>
	)
}
